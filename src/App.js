        ...
        <div className='mx-28 flex'>
          <div className='w-1/3 h-80'>
              <div className='m-4 rounded-xl'>
                <ul>
                  <li className='border-2 border-gray-500  pl-8 bg-gray-200 mb-6 p-7 py-10 hover:bg-gray-400 rounded-xl shadow-md font-semibold'><svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokWidth="1.5" stroke="currentColor" className="w-6 h-6 float-left mr-8">
            ...
            <div className='w-2/3'>
              <div className='border-2 border-gray-500 shadow-md bg-gradient-to-r from-orange-400 to-orange-600 rounded-xl mb-6 p-7 m-4'>
                <PostForm onPost={fetchPosts} />
              </div>
              <p className='mx-8 text-xl font-semibold text-white border-b-2 border-gray-400'>Feed</p>
